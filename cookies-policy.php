...
<p>Cookie-ul este un fișier de mici dimensiuni, format din litere și numere, care va fi stocat pe computerul, terminalul mobil sau alte echipamente ale unui utilizator de pe care se accesează internetul. Cookie-ul este instalat prin solicitarea emisă de către un server web unui browser (ex: Internet Explorer, Chrome, Mozilla, Safari) și este complet pasiv (nu conține programe software, viruși sau spyware și nu poate accesa informațiile de pe hard drive-ul utilizatorului).</p>

<h2>La ce sunt folosite Cookie-urile?</h2>
<p>Site-ul zenhomecleaning.ro utilizează 2 tipuri de cookie-uri:
<p>- Cookie-uri pentru website-ul zenhomecleaning.ro pentru a vă putea menține autentificat în website, și pentru a vă putea memora coșul de cumpărături, wishlist-ul și alte liste de produse relevante.</p>
<p>- Cookie-uri third-party (ex. servicii externe, alte website-uri) pentru a ne ajuta să vă oferim oferte relevante, să construim statistici despre utilizarea website-ului cum ar fi: Facebook, Google, etc.</p>

<h2>Ce cookie-uri folosim pe website?</h2>
<p>În continuare vă punem la dispoziție o listă cu cookie-urile folosite de către noi și pentru ce sunt folosite.</p>
...
<p>- Să folosiți secțiunea coșul meu, să adăugați produse în coș și să plasați comenzi pe website</p>

<h2>Mai multe informatii despre modulele cookie</h2>
<p>Dacă doriți să aflați mai multe informații despre cookie-uri și la ce sunt utilizate, vă recomandăm următoarele linkuri: http://www.youronlinechoices.com/ro/, http://www.allaboutcookies.org/</p>